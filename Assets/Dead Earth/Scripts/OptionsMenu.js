...
function Awake () {
   ...
   /* if(PlayerPrefs.GetInt("ToolTips")==0){
    ...
    if(PlayerPrefs.GetInt("Bloom")==0){
        bloomtext.GetComponent (Text).text = "off";
    }
    else if(PlayerPrefs.GetInt("Bloom")==1){
        bloomtext.GetComponent (Text).text = "on";
    }
    // check motion blur
...
// the playerprefs vailable that is checked to enable hud while in game
/*function ShowHUD(){
    if(PlayerPrefs.GetInt("ShowHUD")==0){
